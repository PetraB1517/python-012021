...
kod = input('Vložte kód součástky: ')

if kod not in sklad:
  print('Tato součástka (kód ' + kod + ') není skladem.')
else:
  mnozstvi = int(input('Vložte požadované množství: '))
  if sklad[kod] < mnozstvi:
    print('Součástky ' + kod + ' je možné prodat pouze ' + str(sklad[kod]) + ' ks.')
    sklad.pop(kod)
  elif sklad[kod] == mnozstvi:
    print('Součástky ' + kod + ' je možné prodat v požadovaném množství - ' + str(sklad[kod]) + ' ks.')
    sklad.pop(kod)
  else:
    print('Součástky ' + kod + ' je možné prodat v požadovaném množství - ' + str(sklad[kod]) + ' ks.')
    sklad[kod] -= mnozstvi
