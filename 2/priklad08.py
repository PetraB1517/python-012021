...
def cena(obsah):
  pricePerOne = 3
  numberOfMess= (len(obsah)//180) +1
  return pricePerOne*numberOfMess



cislo=input("Vložte telefonní číslo: ")

if not phoneNum(cislo):
  print("Špatně vložené telefonní číslo!")
else:
  text=input("Vložte text SMS: ")
  print("Cena této zprávy je " + str(cena(text)) + " Kč.")
